...
**Current release** — compiler + extension ship on the same version.

### Compiler (GitHub Releases)
- **CMake integration** — `cmake/FindVpp.cmake` and `cmake/Vpp.cmake` bundled in installer and portable zip
...
- **Format on save** fixed (requires `vpp` ≥ 1.0.1)
...
### Extension
- Debug, Test Explorer, registry search (see 1.0.4 for consolidated list)
