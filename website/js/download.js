...
(function () {
  ...
  const ICONS = {
    ...
    linux:
      '<svg viewBox="0 0 24 24" aria-hidden="true">'
      + '<path fill="#FCC624" d="M12 2c-3.2 0-5.8 2.4-6 5.5-.3 3.5 2.2 6.5 5.5 7.2 1.1.2 2.2-.1 3.1-.8.9-.7 1.4-1.8 1.4-3V8.5C16 5 14.2 2 12 2Z"/>'
      + '<path fill="#333" d="M8.5 9.5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm5.5 0a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z"/>'
      + '<path fill="#333" d="M10 12.2c.6.45 1.4.7 2 .7s1.4-.25 2-.7"/>'
      + '<ellipse fill="#FCC624" cx="12" cy="17.5" rx="5.5" ry="4" transform="rotate(-8 12 17.5)"/>'
      + '<path fill="#333" d="M9.2 16.8h.01M14.8 16.2h.01"/></svg>',
    macos:
